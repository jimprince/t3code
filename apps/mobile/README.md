...
lane. Normal mobile deployment uses the production workflow documented in
[`docs/mobile/ios-deployment.md`](../../docs/mobile/ios-deployment.md#3-deploy-the-production-build-through-testflight).
