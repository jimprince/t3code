  ...
  function* () {
    ...
    const applyThreadsProjection: ProjectorDefinition["apply"] = Effect.fn(
      ...
      switch (event.type) {
        ...
        // Fork: inbox placement, independent of pinning (see decider).
    ...
    const applyThreadMessagesProjection: ProjectorDefinition["apply"] = Effect.fn(
      ...
      switch (event.type) {
        ...
        case "thread.message-sent": {
          ...
          const nextFileAttachments =
            event.payload.fileAttachments !== undefined
              ? event.payload.fileAttachments
              : previousMessage?.fileAttachments;
