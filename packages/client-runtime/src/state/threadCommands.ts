...
import {
  ...
  type ReorderSidebarThreadInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    reorderSidebar: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:reorder-sidebar",
      execute: (input: ReorderSidebarThreadInput) => reorderSidebarThread(input),
      scheduler,
      concurrency,
    }),
